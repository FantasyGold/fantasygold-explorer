...
.constant('Constants', {
    ...
    DEFAULT_CURRENCY: localStorage.getItem('insight-currency') || 'FGC',
...
angular.module('insight').config(function($routeProvider) {
	...
	when('/blocks', {
		...
		title: 'FantasyGold Blocks solved Today'
	}).
	when('/blocks-date/:blockDate/:startTimestamp?', {
		templateUrl: 'views/block_list.html',
		title: 'FantasyGold Blocks solved '
	}).
	when('/address/:addrStr', {
		templateUrl: 'views/address.html',
		title: 'FantasyGold Address '
	}).
	when('/contracts/:contractAddressStr', {
		templateUrl: 'views/contract.html',
		title: 'FantasyGold Contract '
	}).
	when('/status', {
